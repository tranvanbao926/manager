      ...
      <View style={loginContainer} >
        ...
        <View>
          <TouchableOpacity style={btnSignInStyle} onPress={() => {
            navigate("CustomerFlatList");
          }}>
            <Text style={btnTextSignIn}>Danh sách khách hàng</Text>
          </TouchableOpacity>

          <TouchableOpacity style={btnSignInStyle} onPress={() => {
            navigate("EmployeeFlatList");
          }}>
            <Text style={btnTextSignIn}>Danh sách nhân viên</Text>
          </TouchableOpacity>
        </View>
